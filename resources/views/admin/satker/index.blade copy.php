        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <form action="{{ route('admin.satker.store') }}" method="POST" class="p-6 space-y-5 bg-white">
                    ...
                    {{-- TAMBAHKAN INI: Kontainer Kabupaten (Hidden by default) --}}
    ...
    <script>
        ...
        async function generateSatkerCode(event) {
            ...
            try {
                ...
                if (statusJabatan === 'tidak_ada') {
                ...
                } else if (statusJabatan === 'manajerial' || statusJabatan === 'jabatan_kanwil') {
                    ...
                    // suffix = fullCode.slice(parentKode.length + middle.length);
                    ...
                    const mapping = {
                        ...
                        kepala_prodi: "9010101",
                        wakil_kepala_prodi: "90101011",
                        lembaga: "921",
            ...
            `;
                    ...
                    // suffix hanya untuk jabatan yang memang punya kode tambahan
                ...
                class="flex-1 px-4 py-2 bg-white border border-blue-300 rounded-xl text-sm">
            `);
    ...
    <script>
        ...
        function handleJabatanChange() {
            ...
            if (status === 'jabatan_kotakab') {
                ...
                // Panggil fungsi update nama jika kabupaten sudah terpilih sebelumnya
            ...
            // Logika pengisian otomatis Nama Satker (Eksisting)
            if (status === 'tidak_ada') {
                namaSatkerInput.value = 'Tidak Ada Jabatan';
            } else if (status === 'ada') {
                fungsionalDiv.classList.remove('hidden');
                // Kosongkan nama satker jika jabatan fungsional karena biasanya diisi manual
                namaSatkerInput.value = '';
            } else if (status !== 'jabatan_kotakab' && status !== "") {
                // Untuk manajerial, pelaksana, dll, ambil teks dari dropdown status jabatan
        ...
        function handleWilayahChange() {
            ...
            if (selectedText.includes('PUSAT')) {
                ...
                options = [{
                    ...
                    {
                        val: 'wakil_kepala_prodi',
                        label: 'Wakil Kepala Prodi'
                    },
                    {
                        val: 'lembaga',
                        label: 'Lembaga'
